...
import { 
  Car, ArrowLeft, Clock, Eye, Heart, 
  Share2, AlertCircle, CheckCircle, User, MessageCircle,
  Zap, Shield, Truck, Award
} from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">المزاد غير موجود</p>
          <button 
            onClick={() => router.back()}
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`p-2 rounded-full ${
                  isWatching ? 'bg-red-100 text-red-600' : 'bg-gray-100 text-gray-600'
                } hover:bg-opacity-80`}
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center text-gray-600 space-x-4">
                    <span>{auction.carModel} {auction.carYear}</span>
                    <span>•</span>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-600">247 مشاهدة</span>
                </div>
              </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                    <div className="flex items-center">
                      ...
                      <span>{auction.seller.rating || 5}/5</span>
                    </div>
                    <span>•</span>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-center mb-6">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-2xl font-bold text-red-600">2 ساعة 15 دقيقة</span>
                </div>
                <p className="text-gray-600">ينتهي في {new Date(auction.endTime).toLocaleDateString('ar')}</p>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-gray-700">{auction.totalBids}</span>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {auction.totalBids > 5 && (
                <button className="w-full mt-3 text-blue-600 hover:text-blue-700 text-sm">
                  عرض جميع المزايدات ({auction.totalBids})
                </button>
              )}
            </div>
          </div>
