      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center text-gray-600 space-x-4">
                    <span>{auction.carBrand} {auction.carModel} {auction.carYear}</span>
                    <span>•</span>
                    <span>{auction.category}</span>
                    <span>•</span>
            ...
            {/* Specifications */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4">المواصفات التفصيلية</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                    ...
                    <span>•</span>
                    <span>{auction.seller.completedAuctions} مزاد مكتمل</span>
                    <span>•</span>
                    <span>عضو {auction.seller.joinDate}</span>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">{auction.endTime}</p>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-gray-700">{auction.bidsCount}</span>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {auction.bidsCount > 5 && (
                <button className="w-full mt-3 text-blue-600 hover:text-blue-700 text-sm">
                  عرض جميع المزايدات ({auction.bidsCount})
                </button>
              )}
            </div>
          </div>
